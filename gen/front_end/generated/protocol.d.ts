...
export declare type EnumerableEnum<T> = {
    [K in keyof T]: T[K];
};
...
declare type OpaqueType<Tag extends string> = {
    protocolOpaqueTypeTag: Tag;
};
declare type OpaqueIdentifier<RepresentationType, Tag extends string> = RepresentationType & OpaqueType<Tag>;
