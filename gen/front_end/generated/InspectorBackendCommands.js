...
export function registerCommands(inspectorBackend) {
    ...
    inspectorBackend.registerCommand('Accessibility.getAXNodeAndAncestors', [
        { 'name': 'nodeId', 'type': 'number', 'optional': true },
        { 'name': 'backendNodeId', 'type': 'number', 'optional': true },
        { 'name': 'objectId', 'type': 'string', 'optional': true }
    ], ['nodes']);
    ...
    inspectorBackend.registerEnum('Audits.DeprecationIssueType', { DeprecationExample: 'DeprecationExample', Untranslated: 'Untranslated' });
    ...
    inspectorBackend.registerCommand('CSS.setSupportsText', [
        { 'name': 'styleSheetId', 'type': 'string', 'optional': false },
        { 'name': 'range', 'type': 'object', 'optional': false }, { 'name': 'text', 'type': 'string', 'optional': false }
    ], ['supports']);
    ...
    inspectorBackend.registerCommand('Input.imeSetComposition', [
        { 'name': 'text', 'type': 'string', 'optional': false },
    ...
    inspectorBackend.registerEvent('Network.requestWillBeSentExtraInfo', ['requestId', 'associatedCookies', 'headers', 'connectTiming', 'clientSecurityState']);
    ...
    inspectorBackend.registerEnum('Page.PermissionsPolicyBlockReason', { Header: 'Header', IframeAttribute: 'IframeAttribute', InFencedFrameTree: 'InFencedFrameTree' });
    ...
    inspectorBackend.registerCommand('Page.setFontFamilies', [
    ...
    inspectorBackend.registerEnum('Page.SetSPCTransactionModeRequestMode', { None: 'none', Autoaccept: 'autoaccept', Autoreject: 'autoreject' });
    ...
    inspectorBackend.registerCommand('Storage.getInterestGroupDetails', [
    ...
    inspectorBackend.registerCommand('Target.autoAttachRelated', [
        { 'name': 'targetId', 'type': 'string', 'optional': false },
        { 'name': 'waitForDebuggerOnStart', 'type': 'boolean', 'optional': false }
    ], []);
    ...
    inspectorBackend.registerEvent('Fetch.requestPaused', [
        'requestId', 'request', 'frameId', 'resourceType', 'responseErrorReason', 'responseStatusCode',
        'responseStatusText', 'responseHeaders', 'networkId'
    ]);
    ...
    inspectorBackend.registerCommand('Fetch.continueResponse', [
        { 'name': 'requestId', 'type': 'string', 'optional': false },
