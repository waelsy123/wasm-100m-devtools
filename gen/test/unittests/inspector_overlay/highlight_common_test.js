...
describe('highlight common helper', () => {
    ...
    it('can map points using writing-mode matrices', () => {
        ...
        assert.deepStrictEqual(applyMatrixToPoint(point, matrix), { x: 0, y: 0 }, 'The identity matrix does not move the point');
        point.x = 10;
        point.y = 10;
        matrix.translateSelf(10, 10, 0);
        assert.deepStrictEqual(applyMatrixToPoint(point, matrix), { x: 20, y: 20 }, 'A simple translation matrix does transform a point');
    });
});
//# sourceMappingURL=highlight_common_test.js.map