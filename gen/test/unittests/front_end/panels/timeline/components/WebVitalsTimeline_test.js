...
describeWithLocale('WebVitalsTimeline', () => {
    ...
    // Not yet implementable
    it.skip('[crbug.com/1140910] should calculate the timing of events relative to the start of the trace if there is no navigation before it', () => { });
    // Not yet implementable
    ...
    // Not yet implementable
    it.skip('[crbug.com/1140910] should render different marker symbols based on the time since the last navigation', () => { });
});
//# sourceMappingURL=WebVitalsTimeline_test.js.map