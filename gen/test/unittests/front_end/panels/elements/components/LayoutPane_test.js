...
describeWithLocale('LayoutPane', async () => {
    ...
    it('renders settings', async () => {
        ...
        assert.deepEqual(queryLabels(component, '[data-boolean-setting]'), [{ label: 'Boolean setting title', input: 'INPUT' }]);
    });
    it('sends event when a setting is changed', async () => {
        ...
        const eventPromise = getEventPromise(component, 'settingchanged');
        input.click();
