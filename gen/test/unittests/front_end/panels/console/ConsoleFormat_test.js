...
describe('ConsoleFormat', () => {
    describe('format', () => {
        ...
        it('deals with format strings without formatting specifiers', () => {
            assert.deepNestedPropertyVal(Console.ConsoleFormat.format('This string does NOT contain specifiers', []), 'tokens', [
                {
                    type: 'string',
        ...
        it('deals with %c', () => {
            assert.deepNestedPropertyVal(Console.ConsoleFormat.format('%cColorful%c!', [
        ...
        it('deals with %s', () => {
            assert.deepNestedPropertyVal(Console.ConsoleFormat.format('%s%s%s!', [
            ...
            assert.deepNestedPropertyVal(Console.ConsoleFormat.format('%s!', [
        ...
        it('deals with %d, %i, and %f', () => {
            assert.deepNestedPropertyVal(Console.ConsoleFormat.format('%d %i %f', [
            ...
            assert.deepNestedPropertyVal(Console.ConsoleFormat.format('%f %i %d', [
        ...
        it('deals with ANSI color codes to change text decoration', () => {
            assert.deepNestedPropertyVal(Console.ConsoleFormat.format('\x1B[4m1\x1B[9;24;53m2\x1B[29;4;53m3\x1B[24;29;55m', []), 'tokens', [
        ...
        it('deals with unsupported ANSI color codes', () => {
            assert.deepNestedPropertyVal(Console.ConsoleFormat.format('\x1B[1;254mHello\x1B[255m\x1B[2mWorld\x1B[128m', []), 'tokens', [
                { type: 'style', value: 'font-weight:bold' },
        ...
        it('deals with ANSI color codes', () => {
            ...
            for (let i = 0; i <= 255; i += 33) {
                assert.deepNestedPropertyVal(Console.ConsoleFormat.format(`\x1B[38;2;${i}m\x1B[38;2;5;${i};m\x1B[48;2;${i};${i};${i};39m\x1B[49m`, []), 'tokens', [
        ...
        it('deals with ANSI colors and formatting specifiers', () => {
            const { tokens } = Console.ConsoleFormat.format('\x1B[30m%d\x1B[31m%f\x1B[32m%s\x1B[33m%d\x1B[34m%f\x1B[35m%s\x1B[36m%d\x1B[37m%f\x1B[m', [1, 1.1, 'a', 2, 2.2, 'b', 3, 3.3].map(obj => SDK.RemoteObject.RemoteObject.fromLocalObject(obj)));
        ...
        it('deals with ANSI color combinations', () => {
            const { tokens } = Console.ConsoleFormat.format('\x1B[30m1\x1B[40m2\x1B[31m3\x1B[41m4\x1B[90m5\x1B[100m6\x1B[91m7\x1B[101m8', []);
            assert.deepEqual(tokens, [
                { type: 'style', value: 'color:var(--console-color-black)' },
                { type: 'string', value: '1' },
...
//# sourceMappingURL=ConsoleFormat_test.js.map