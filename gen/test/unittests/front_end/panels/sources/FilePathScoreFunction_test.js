...
describe('FilePathScoreFunction', () => {
    describe('score', () => {
        ...
        it('should highlight matching filename, but not path', () => {
            const highlightsFullMatch = new Array();
            const highlightsCamelCase = new Array();
            const highlightsDash = new Array();
            const highlightsUnderscore = new Array();
            const highlightsDot = new Array();
            const highlightsWhitespace = new Array();
        ...
        it('should highlight path when not matching filename', () => {
            const highlightsConsecutive = new Array();
            const highlightsNonConsecutive = new Array();
...
//# sourceMappingURL=FilePathScoreFunction_test.js.map