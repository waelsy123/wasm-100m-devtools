...
const { assert } = chai;
async function renderTrustTokensView(tokens, deleteClickHandler = () => { }) {
...
describeWithLocale('TrustTokensView', () => {
    ...
    it('calls the delete handler with the right issuer when the delete button is clicked in a row', async () => {
        ...
        let resolveDeleteButtonPromise;
        const deleteButtonClicked = new Promise(resolve => {
...
//# sourceMappingURL=TrustTokensView_test.js.map