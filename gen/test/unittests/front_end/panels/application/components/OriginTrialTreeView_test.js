...
const trialWithMultipleTokens = {
    ...
    tokensWithStatus: [
        ...
        {
            status: "WrongOrigin" /* WrongOrigin */,
            rawTokenText: tokenPlaceHolder,
            parsedToken: {
                trialName: 'AppCache',
...
const trialWithSingleToken = {
    ...
    status: "ValidTokenNotProvided" /* ValidTokenNotProvided */,
    tokensWithStatus: [
        {
            ...
            trials: [
                {
                    ...
                    tokensWithStatus: [
                        {
                            status: "UnknownTrial" /* UnknownTrial */,
                            parsedToken: {
...
//# sourceMappingURL=OriginTrialTreeView_test.js.map