...
const makeFrame = () => {
    const newFrame = {
        ...
        getCrossOriginIsolatedContextType: () => "NotIsolatedFeatureDisabled" /* NotIsolatedFeatureDisabled */,
        getSecureContextType: () => "SecureLocalhost" /* SecureLocalhost */,
        getGatedAPIFeatures: () => ["SharedArrayBuffers" /* SharedArrayBuffers */,
            ...
            target: () => ({
                ...
                model: () => ({
                    getSecurityIsolationStatus: () => ({
                        coep: {
                            value: "None" /* None */,
                            reportOnlyValue: "None" /* None */,
                        },
                        coop: {
                            value: "SameOrigin" /* SameOrigin */,
                            reportOnlyValue: "SameOrigin" /* SameOrigin */,
                        },
                    }),
                }),
            }),
...
//# sourceMappingURL=FrameDetailsView_test.js.map