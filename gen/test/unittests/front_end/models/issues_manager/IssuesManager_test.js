...
describeWithEnvironment('IssuesManager', () => {
    it('collects issues from an issues model', () => {
        ...
        issuesManager.addEventListener("IssueAdded" /* IssueAdded */, event => dispatchedIssues.push(event.data.issue));
        mockModel.dispatchEventToListeners("IssueAdded" /* IssueAdded */, { issuesModel: mockModel, inspectorIssue: mkInspectorCspIssue('url1') });
        mockModel.dispatchEventToListeners("IssueAdded" /* IssueAdded */, { issuesModel: mockModel, inspectorIssue: mkInspectorCspIssue('url2') });
    ...
    it('filters third-party issues when the third-party issues setting is false, includes them otherwise', () => {
        ...
        issuesManager.addEventListener("IssueAdded" /* IssueAdded */, event => firedIssueAddedEventCodes.push(event.data.issue.code()));
...
describeWithEnvironment('IssuesManager', () => {
    ...
    it('hides issues added after setting has been initialised', () => {
        ...
        issuesManager.modelAdded(mockModel);
        const hiddenIssues = [];
        issuesManager.addEventListener("IssueAdded" /* IssueAdded */, event => {
    ...
    it('hides issues present in IssuesManager when setting is updated', () => {
        ...
        issuesManager.modelAdded(mockModel);
        let hiddenIssues = [];
        issuesManager.addEventListener("FullUpdateRequired" /* FullUpdateRequired */, () => {
            hiddenIssues = [];
    ...
    it('unhides issues present in IssuesManager when setting is updated', () => {
        ...
        hideIssueByCodeSetting.set({
            ...
            'HiddenStubIssue2': "Hidden" /* Hidden */,
            'UnhiddenStubIssue1': "Unhidden" /* Unhidden */,
            'UnhiddenStubIssue2': "Unhidden" /* Unhidden */,
        });
...
//# sourceMappingURL=IssuesManager_test.js.map