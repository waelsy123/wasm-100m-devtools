...
`);
    ...
    it('can handle duplicate file names for different ui source code instances', async () => {
        ...
        const secondContentProvider = TextUtils.StaticContentProvider.StaticContentProvider.fromString(DOCUMENT_URL, RESOURCE_TYPE, '<html>Second document</html>');
        ...
        assert.notStrictEqual(formattedResult.formattedSourceCode.url(), duplicateFormattedResult.formattedSourceCode.url());
...
//# sourceMappingURL=SourceFormatter_test.js.map