...
describe('TextUtils.TextRange.TextRange', () => {
    ...
    it('can be checked for emptiness', () => {
        const textRange = TextUtils.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 1, endColumn: 2 });
        assert.isTrue(textRange.isEmpty(), 'the range was non-empty');
    });
    describe('immediatelyPrecedes()', () => {
        it('can handle non-range inputs', () => {
            const textRange = TextUtils.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 3, endColumn: 4 });
        ...
        it('can judge immediate preceedence correctly', () => {
            const textRangeA = TextUtils.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 3, endColumn: 4 });
            const textRangeB = TextUtils.TextRange.TextRange.fromObject({ startLine: 3, startColumn: 4, endLine: 5, endColumn: 6 });
            const textRangeC = TextUtils.TextRange.TextRange.fromObject({ startLine: 5, startColumn: 6, endLine: 7, endColumn: 8 });
    ...
    it('can report the line count', () => {
        const textRangeA = TextUtils.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 1, endColumn: 2 });
        const textRangeB = TextUtils.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 2, endColumn: 2 });
        const textRangeC = TextUtils.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 12, endColumn: 2 });
    ...
    it('can be compared', () => {
        const textRangeA = TextUtils.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 3, endColumn: 4 });
        const textRangeB = TextUtils.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 4, endLine: 3, endColumn: 4 });
        const textRangeC = TextUtils.TextRange.TextRange.fromObject({ startLine: 2, startColumn: 2, endLine: 3, endColumn: 4 });
        const textRangeD = TextUtils.TextRange.TextRange.fromObject({ startLine: 3, startColumn: 1, endLine: 3, endColumn: 4 });
    ...
    it('can be compared with TextUtils.TextRange.TextRange.comparator', () => {
        ...
        const textRangeC = TextUtils.TextRange.TextRange.fromObject({ startLine: 2, startColumn: 2, endLine: 3, endColumn: 4 });
        const textRangeD = TextUtils.TextRange.TextRange.fromObject({ startLine: 3, startColumn: 1, endLine: 3, endColumn: 4 });
        assert.strictEqual(TextUtils.TextRange.TextRange.comparator(textRangeA, textRangeA), 0, 'A should be equal to itself');
    ...
    it('can be adjusted relative to a position', () => {
        const textRange = TextUtils.TextRange.TextRange.fromObject({ startLine: 4, startColumn: 3, endLine: 6, endColumn: 7 });
    ...
    it('can be adjusted relative from a position', () => {
        ...
        const textRange2 = TextUtils.TextRange.TextRange.fromObject({ startLine: 0, startColumn: 3, endLine: 6, endColumn: 7 });
        ...
        const textRange3 = TextUtils.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 3, endLine: 0, endColumn: 7 });
    ...
    it('can check if a position is contained', () => {
        ...
        const textRangeB = TextUtils.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 1, endColumn: 4 });
    ...
    describe('rebaseAfterTextEdit()', () => {
        ...
        it('can rebase a range if its rebased range neither starts nor ends at end of the edited range', () => {
            const textRange = TextUtils.TextRange.TextRange.fromObject({ startLine: 4, startColumn: 4, endLine: 6, endColumn: 8 });
            const rebasedTextRange = textRange.rebaseAfterTextEdit(originalRange, editedRange);
        ...
        it('can rebase a range if its rebased range starts at the end of the edited range', () => {
            const textRangeToRebase = TextUtils.TextRange.TextRange.fromObject({ startLine: 3, startColumn: 5, endLine: 6, endColumn: 8 });
        ...
        it('can rebase a range if its rebased range starts and ends at the end of the edited range', () => {
            const textRangeToRebase = TextUtils.TextRange.TextRange.fromObject({ startLine: 3, startColumn: 5, endLine: 3, endColumn: 8 });
            const rebasedTextRange = textRangeToRebase.rebaseAfterTextEdit(originalRange, editedRange);
...
//# sourceMappingURL=TextRange_test.js.map