...
`);
    ...
    it('formats color values', () => {
        const formattedCode = formatSCSS('p { color: color; red: red; color: #000; color: #FFF; color: #123AbC; color: #faebfe; color:papayawhip; }');
...
//# sourceMappingURL=SCSSFormatter_test.js.map