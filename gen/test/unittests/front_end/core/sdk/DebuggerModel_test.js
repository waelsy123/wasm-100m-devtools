...
describeWithEnvironment('LocationRanges', () => {
    ...
    function createRange(scriptId, startLine, startColumn, endLine, endColumn) {
        return new SDK.DebuggerModel.LocationRange(scriptId, new SDK.DebuggerModel.ScriptPosition(startLine, startColumn), new SDK.DebuggerModel.ScriptPosition(endLine, endColumn));
    }
    function sort(locationRange) {
    ...
    function checkIsMaximallyMerged(locationRange) {
...
//# sourceMappingURL=DebuggerModel_test.js.map