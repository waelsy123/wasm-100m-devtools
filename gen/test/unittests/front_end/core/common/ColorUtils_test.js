...
describe('ColorUtils', async () => {
    ...
    it('is able to calculate the contrast ratio between two colors', () => {
        const firstColor = [1, 0, 0, 1];
        const secondColor = [0, 0, 1, 1];
        assert.strictEqual(Common.ColorUtils.contrastRatio(firstColor, secondColor), 2.148936170212766, 'contrast ratio was not calculated correctly');
    });
...
//# sourceMappingURL=ColorUtils_test.js.map