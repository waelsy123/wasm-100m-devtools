...
describeWithRealConnection('ObjectPropertiesSection', () => {
    it('can reveal private accessor values', async () => {
        ...
        const { properties } = await result.object.getAllProperties(true /* accessorPropertiesOnly */, false /* generatePreview */);
        ...
        ObjectUI.ObjectPropertiesSection.ObjectPropertyTreeElement.populateWithProperties(treeOutline.rootElement(), properties, null, true /* skipProto */, false /* skipGettersAndSetters */, result.object);
...
//# sourceMappingURL=ObjectPropertiesSection_test.js.map