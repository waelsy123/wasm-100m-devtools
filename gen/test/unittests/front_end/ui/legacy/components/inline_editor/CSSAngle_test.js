...
describe('CSSAngle', () => {
    ...
    describe('#CSSAngleUtils', () => {
        ...
        it('parses CSS properties with angles correctly', () => {
            assert.deepEqual(InlineEditor.CSSAngleUtils.parseText('rotate(45deg)'), { value: 45, unit: "deg" /* Deg */ });
            assert.deepEqual(InlineEditor.CSSAngleUtils.parseText('rotate(calc(45deg))'), { value: 45, unit: "deg" /* Deg */ });
            assert.deepEqual(InlineEditor.CSSAngleUtils.parseText('skew(20deg)'), { value: 20, unit: "deg" /* Deg */ });
            assert.deepEqual(InlineEditor.CSSAngleUtils.parseText('rotateX(20deg)'), { value: 20, unit: "deg" /* Deg */ });
            assert.deepEqual(InlineEditor.CSSAngleUtils.parseText('rotateY(20deg)'), { value: 20, unit: "deg" /* Deg */ });
            assert.deepEqual(InlineEditor.CSSAngleUtils.parseText('rotateZ(20deg)'), { value: 20, unit: "deg" /* Deg */ });
            assert.deepEqual(InlineEditor.CSSAngleUtils.parseText('rotate3d(1, 1, 1, 20deg)'), { value: 20, unit: "deg" /* Deg */ });
            assert.deepEqual(InlineEditor.CSSAngleUtils.parseText('linear-gradient(10.5grad, black, white)'), { value: 10.5, unit: "grad" /* Grad */ });
            assert.deepEqual(InlineEditor.CSSAngleUtils.parseText('conic-gradient(black 25%, white 10deg 50%, black 20deg 75%, white 30deg)'), { value: 10, unit: "deg" /* Deg */ });
            assert.deepEqual(InlineEditor.CSSAngleUtils.parseText('rotate3d(2, -1, -1, -0.2rad);'), { value: -0.2, unit: "rad" /* Rad */ });
            assert.deepEqual(InlineEditor.CSSAngleUtils.parseText('hue-rotate(1.5turn)'), { value: 1.5, unit: "turn" /* Turn */ });
            assert.deepEqual(InlineEditor.CSSAngleUtils.parseText('oblique 25deg'), { value: 25, unit: "deg" /* Deg */ });
            assert.deepEqual(InlineEditor.CSSAngleUtils.parseText('ray(20.8deg closest-side)'), { value: 20.8, unit: "deg" /* Deg */ });
        ...
        it('converts angles in degree to other units correctly', () => {
            assert.deepEqual(InlineEditor.CSSAngleUtils.getAngleFromRadians(Math.PI / 4, "grad" /* Grad */), {
                value: 50,
                unit: "grad" /* Grad */,
            });
            assert.deepEqual(InlineEditor.CSSAngleUtils.getAngleFromRadians(Math.PI / 4, "rad" /* Rad */), {
                value: Math.PI / 4,
                unit: "rad" /* Rad */,
            });
            assert.deepEqual(InlineEditor.CSSAngleUtils.getAngleFromRadians(Math.PI / 4, "turn" /* Turn */), {
                value: 0.125,
                unit: "turn" /* Turn */,
            });
            assert.deepEqual(InlineEditor.CSSAngleUtils.getAngleFromRadians(Math.PI / 4, "deg" /* Deg */), {
                value: 45,
                unit: "deg" /* Deg */,
            });
        });
        ...
        it('cycles angle units correctly', () => {
            assert.strictEqual(InlineEditor.CSSAngleUtils.getNextUnit("deg" /* Deg */), "grad" /* Grad */);
            assert.strictEqual(InlineEditor.CSSAngleUtils.getNextUnit("grad" /* Grad */), "rad" /* Rad */);
            assert.strictEqual(InlineEditor.CSSAngleUtils.getNextUnit("rad" /* Rad */), "turn" /* Turn */);
            assert.strictEqual(InlineEditor.CSSAngleUtils.getNextUnit("turn" /* Turn */), "deg" /* Deg */);
        });
...
//# sourceMappingURL=CSSAngle_test.js.map