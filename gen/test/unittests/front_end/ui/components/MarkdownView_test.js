...
describe('MarkdownView', async () => {
    describe('renderToken', async () => {
        ...
        it('renders link with valid key', () => {
            ...
            const renderResult = MarkdownView.MarkdownView.renderToken({ type: 'link', text: 'learn more', href: 'exampleLink' })
                .strings.join('');
        ...
        it('renders icon with valid key', () => {
            ...
            const renderResult = MarkdownView.MarkdownView.renderToken({ type: 'image', text: 'phone', href: 'testExampleImage' })
                .strings.join('');
        ...
        it('renders image with valid key', () => {
            ...
            const renderResult = MarkdownView.MarkdownView.renderToken({ type: 'image', text: 'phone', href: 'exampleImage' }).strings.join('');
            assert.isTrue(renderResult.includes('<devtools-markdown-image'));
        });
...
//# sourceMappingURL=MarkdownView_test.js.map