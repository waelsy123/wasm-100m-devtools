...
describe('DataGrid', () => {
    ...
    describe('DataGrid.DataGridUtils.calculateColumnWidthPercentageFromWeighting', () => {
        ...
        it('correctly divides columns based on the weighting', async () => {
            ...
            const calculatedWidths = columns.map(col => DataGrid.DataGridUtils.calculateColumnWidthPercentageFromWeighting(columns, col.id));
        ...
        it('errors if a column has a weighting of less than 1', async () => {
            ...
            assert.throws(() => DataGrid.DataGridUtils.calculateColumnWidthPercentageFromWeighting(columns, columns[0].id), 'Error with column column-0: width weightings must be >= 1.');
        });
    });
...
//# sourceMappingURL=DataGrid_test.js.map