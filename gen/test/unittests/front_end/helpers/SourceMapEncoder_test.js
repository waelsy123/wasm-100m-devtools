...
describe('SourceMapEncoder', () => {
    ...
    it('can encode multiple lines correctly', () => {
        ...
        assert.strictEqual(';AACA;;;AAEA', SourceMapEncoder.encodeSourceMap(['1:0 => a.js:1:0', '4:0 => a.js:3:0']).mappings);
    });
    it('can encode relative offset mappings correctly', () => {
        // Relative columns.
        assert.strictEqual('AAAA,EAAI,IAAD', SourceMapEncoder.encodeSourceMap(['0:0 => a.js:0:0', '0:2 => a.js:0:4', '0:6 => a.js:0:3']).mappings);
        // Reset after new line.
        assert.strictEqual('AAAA,EAAC;MAAE', SourceMapEncoder.encodeSourceMap(['0:0 => a.js:0:0', '0:2 => a.js:0:1', '1:6 => a.js:0:3']).mappings);
    ...
    it('can encode names correctly', () => {
        assert.deepEqual({
            ...
            sourceRoot: undefined,
            sourcesContent: undefined,
        }, SourceMapEncoder.encodeSourceMap(['0:0 => a.js:0:0@a', '1:0 => a.js:1:0@b', '2:0 => a.js:2:0@c', '3:0 => a.js:3:0@a']));
    });
...
//# sourceMappingURL=SourceMapEncoder_test.js.map