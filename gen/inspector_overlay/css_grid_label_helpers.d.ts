...
declare type PositionDataWithNames = PositionData & {
    names: string[][];
};
 ...
 */
export declare function drawGridTrackSizes(container: HTMLElement, trackSizes: Array<TrackSize>, direction: 'row' | 'column', canvasSize: CanvasSize, emulationScaleFactor: number, writingModeMatrix?: DOMMatrix | undefined, writingMode?: string | undefined): void;
/**
